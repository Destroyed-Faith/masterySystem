...
export const COMBAT_MANEUVERS: CombatManeuver[] = [
  ...
  // ========================================
  {
    ...
    tags: ["movement", "basic"],
    effect:
      "Move up to your Speed. You may draw or sheathe a weapon as part of Movement. Provokes movement-triggered Reactions normally.",
  },
  {
    id: "dash",
    name: "Dash",
    ...
    effect:
      "Move up to **double your normal Speed**. You cannot perform your base Attack Action this Turn, but additional Attack Actions from Stones or another source may still be used. Provokes movement-triggered Reactions normally.",
  },
  {
    id: "disengage",
    name: "Disengage",
    ...
    effect:
      "Move up to your normal Speed **without provoking movement-triggered Reactions**. You cannot perform your base Attack Action this Turn unless another effect grants an additional Attack Action.",
  },
  {
    id: "quick-load",
    name: "Quick Load",
  ...
  },
  {
    ...
    effect:
      "Standing up costs **1 Attack Action** but does not consume Movement. After standing, you may use Movement normally. Standing itself does not provoke Reactions.",
  },
  ...
  // ========================================
  {
    ...
    effect:
      "Move up to **4× your normal Speed** directly away from danger. Until the start of your next Turn you cannot make Attacks, use Reactions, or spend Stones. Provokes movement-triggered Reactions normally. The GM may transition into a chase if appropriate.",
  },
  ...
  // ========================================
  {
    ...
    effect:
      "Trigger: you are hit by an Attack or would take damage. Gain **+MR × 2 Armor** against that triggering event only.",
  },
  {
    id: "evade",
    name: "Evade",
    ...
    tags: ["reaction", "defensive", "basic", "basic-reaction"],
    effect:
      "Trigger: you are targeted by an Attack, before the result is finalized. Gain **+MR × 2 Evade** against that Attack only.",
  },
  {
    id: "counterattack",
    name: "Counterattack",
    ...
    effect:
      "Trigger: a creature hits you with an Attack and is a valid target. Immediately make a **Basic Attack** (Weapon Damage + MR × 2d8). No Active Power effects.",
  },
  {
    id: "dive-for-cover",
    name: "Dive for Cover",
  ...
  // ========================================
  {
    ...
    effect:
      "When an enemy **leaves your melee reach** by movement, spend your Reaction to make **one Basic Attack** (Weapon Damage + MR × 2d8). No Active Power effects.",
  },
  ...
  },
  {
    ...
    effect:
      "Costs **1 Attack Action**. Resolve an **Opposed Attribute Contest** against the grappler (Might or Agility, keep Mastery Rank; no TN, no Raises, no Skill Points). If you win, the Grapple ends. If you lose or tie, the Grapple remains.",
  },
  {
    id: "grapple-release",
    ...
    effect:
      "Voluntarily end the Grapple. Costs nothing. Both creatures lose the Grappled state. Required before you attack the held creature with a weapon.",
  },
  {
    id: "reckless-attack",
...
function meetsRequirements(actor: any, maneuver: CombatManeuver): boolean {
  ...
  if (req.requiresGrappleRole || req.requiresNotGrappling) {
    ...
    if (req.requiresNotGrappling && role !== null) return false;
    if (req.requiresGrappleRole && role !== req.requiresGrappleRole) return false;
  }
