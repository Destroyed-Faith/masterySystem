 ...
 */
export function getArmorPenalties(armorType: ArmorType): EquipmentPenalties {
  switch (armorType) {
 ...
 */
export function getShieldPenalties(shieldType: ShieldType): { evade: number; evadeBonus: number; armorBonus: number } {
  switch (shieldType) {
 ...
 */
export function calculateEquipmentPenalties(actor: any): EquipmentPenalties {
 ...
 */
export function applySkillPenalties(
  actor: any,
  skill: string,
  baseDice: number
): number {
 ...
 */
export function getEquipmentPenaltySummary(actor: any): string[] {
  const penalties = calculateEquipmentPenalties(actor);
 ...
 */
export function getShieldBonuses(shieldType: ShieldType): { armor: number; evade: number } {
