...
export const STONE_RITUALS_CATALOG: RitualCatalogEntry[] = [
  {
    id: 'ritual-identify',
    name: 'Identify',
    ...
    intro:
      'You trace runes and whisper truths into an unknown item — and it whispers back. Learn name, level, powers, school, and command words.',
    raises: [
