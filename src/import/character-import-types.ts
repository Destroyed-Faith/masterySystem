...
export const CHARACTER_IMPORT_SCHEMA_VERSION = 1 as const;
export const CHARACTER_IMPORT_EXPORT_KIND = 'mastery-character-import' as const;
export const FOUNDRY_ACTOR_IMPORT_EXPORT_KIND = 'mastery-foundry-actor' as const;
export const CHARACTER_IMPORT_SYSTEM_ID = 'mastery-system' as const;

export const CHARACTER_IMPORT_ATTRIBUTE_KEYS = [
  'might',
  'agility',
  'vitality',
  'intellect',
...
export type CharacterImportDocument =
  | MasteryCharacterImportDocument
  | MasteryFoundryActorImportDocument;
