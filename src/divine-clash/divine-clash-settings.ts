 ...
 */
export function registerDivineClashSettings(): void {
  // Divine Clash Scene ID
  (game as any).settings.register('mastery-system', 'divineClashSceneId', {
  ...
  (game as any).settings.register('mastery-system', 'divineClashCleanupAvatars', {
  ...
  (game as any).settings.register('mastery-system', 'divineClashBasePowerStoneActorId', {
  ...
  (game as any).settings.register('mastery-system', 'divineClashBaseVitalityStoneActorId', {
