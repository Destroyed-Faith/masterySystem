...
const TREE_OR_SCHOOL_TO_ATTRIBUTE: Record<string, string> = {
  // Mastery trees
  crusader: "might",
  juggernaut: "might",
...
function normalizeTreeOrSchoolLabel(raw: string): string {
 ...
 */
export function getAttackAttributeForPowerTreeOrSchool(treeOrSchool: string | undefined | null): string | null {
  if (treeOrSchool == null || typeof treeOrSchool !== "string") return null;
