 ...
 */
export function validateNoDamageTypes(power: any): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function validateChargedPower(power: EmbeddedPowerData): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
 ...
 */
export function validatePower(power: any): { valid: boolean; errors: string[] } {
  const errors: string[] = [];
  ...
  if (power.category && power.levels) {
    const chargedCheck = validateChargedPower(power as EmbeddedPowerData);
