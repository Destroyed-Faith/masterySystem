...
export const MAGIC_POWERS: Record<string, MagicPowerDefinition[]> = {
  'Pyromancy': [
    {
      name: 'Firebolt',
      school: 'Pyromancy',
 ...
 */
export function getMagicPowersBySchool(schoolName: string): MagicPowerDefinition[] {
 ...
 */
export function getMagicPower(schoolName: string, powerName: string): MagicPowerDefinition | undefined {
 ...
 */
export function getAllMagicPowers(): MagicPowerDefinition[] {
