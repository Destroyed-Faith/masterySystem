  ...
  coreTraits: [
    {
      ...
      name: 'Core Directive',
      effect:
        'You are dedicated to preserve the creation of the gods. Mastery Rank per Safe Haven Rest: when you act clearly in service of it, gain +1 Free Raise on one relevant roll. If you knowingly act against it, mark 1d8 Stress.',
