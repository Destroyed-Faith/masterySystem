...
export const HALFLINGS_ECHO: EchoDefinition = {
  key: 'halflings',
  name: 'Halflings',
  tagline: 'The hearth is not a place. It is whoever still shares the last crust.',
  theme:
    'Hunted remnants of ordinary joy \u2014 fugitives who survive through kinship, hidden paths, quick hands, and the refusal to let Hell turn hunger into identity.',
  summary:
    'The hearthfolk of Tyhra: nearly extinct survivors whose warmth, memory, and soul-rich blood are prized as demonic delicacies. Most live on the run; others survive in locked cellars and feast-prisons, waiting to be served.',
