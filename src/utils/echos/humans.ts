...
export const HUMANS_ECHO: EchoDefinition = {
  ...
  coreTraits: [
    {
      ...
      name: 'Bad Options',
      effect:
        'Mastery Rank per Safe Haven Rest: after you roll a Skill check, you may reroll a die. Multiple uses on the same roll are allowed up to your daily uses. A die can\u2019t be rerolled twice.',
    ...
    },
    {
      ...
      effect:
        'Mastery Rank per Safe Haven Rest: before you roll any check (including attack rolls), you may add +(Mastery Rank \u00d7 4) to that roll.',
  ...
  deck: [
    ...
    },
    {
      ...
      trigger:
        'The day turns ugly \u2014 travel, pursuit, hostile ground, scarcity, or the kind of risk you only learn by surviving it.',
      options: [
        {
          id: 'follow-the-signs',
