...
export const MARKED_ONE_POWERS: NewArtifactPowerData[] = [
    {
        name: 'Cursed Lance',
        category: 'active',
        tags: [],
    ...
    },
    {
        ...
        levels: {
            ...
            '2': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'As above, add +3d8 damage', dice: '3d8' },
                specials: []
            },
            '3': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'As above, add +4d8 damage', dice: '4d8' },
                specials: []
            },
            '4': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'As above, add +6d8 damage', dice: '6d8' },
                specials: []
            }
        }
    },
    {
        ...
        levels: {
            '1': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +3 dice on Spirit Saves' },
                specials: []
            },
            '2': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +6 dice on Spirit Saves' },
                specials: []
            },
            '3': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +9 dice on Spirit Saves' },
                specials: []
            },
            '4': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +12 dice on Spirit Saves' },
                specials: []
            }
        }
    },
    ...
    },
    {
        ...
        levels: {
            '1': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'End of your turn: if you applied or increased Hex on any target this round, heal 1d8 HP', dice: '1d8' },
                specials: []
            },
            '2': {
