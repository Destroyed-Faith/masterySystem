    ...
    },
    {
        ...
        levels: buildLevels((lvl) => {
            ...
            return activeBuffRow({
                duration: DURATION_MR_ROUNDS,
                effectText:
                    `At the start of your turn, reduce **one** eligible negative ongoing creature effect affecting you by **${amt}**.`,
    ...
    },
    {
        ...
        levels: buildLevels((lvl) => {
            ...
            return activeBuffRow({
                ...
                duration: DURATION_MR_ROUNDS,
                effectText:
                    `Requires **Parry** Passive. After you spend Parry against a Martial Attack or Spell, regain up to **${regain}** total Parry per Round. You cannot regain more than you spent, and the Pool cannot exceed the amount with which you entered Parry that Turn.`,
    ...
    },
    {
        ...
        levels: buildLevels((lvl) => {
            ...
            return activeBuffRow({
                ...
                duration: DURATION_MR_ROUNDS,
                effectText:
                    `Requires **Absorption** Passive. The first Absorption harvest each Round generates **+${extra} Temporary Colorless ${noun}**.`,
                mechanics: { duration: 'masteryRankRounds' },
            });
        }),
    },
    {
        ...
        levels: buildLevels((lvl) =>
            activeBuffRow({
                ...
                duration: DURATION_MR_ROUNDS,
                effectText:
                    `Requires **Damage Negation** Passive. Each Round gain **${lvl} Reinforced Negation Die` +
