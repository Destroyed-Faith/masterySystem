 ...
 */
export const MASTERY_POWERS: Record<string, PowerDefinition[]> = {
  'Battlemage': [
    {
  ...
  'Crusader': [
    {
      ...
      tree: 'Crusader',
      powerType: 'active',
      description: 'More powers will be added soon.',
      levels: [
        {
          level: 1,
          type: 'Active',
          effect: 'To be implemented from Players Guide.'
        }
      ]
    }
  ]
...
export function getTreesWithPowers(): string[] {
  return Object.keys(MASTERY_POWERS).filter(tree => 
    MASTERY_POWERS[tree].length > 0 && 
