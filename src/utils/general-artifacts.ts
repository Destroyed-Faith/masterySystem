...
const LOR_KETHS_STAFF: GeneralArtifactDefinition = {
  ...
  levelProgression: [
    ...
    },
    {
      ...
      duration: 'Instant',
      effect:
        "Lor-Keth's Staff supports the Might Ability Ignore Armor and pre-fills Rank 2. Rank 1 must still be paid normally.",
    ...
    },
    {
      ...
      duration: 'Instant',
      effect:
        "Lor-Keth's Staff pre-fills Rank 3 of the Might Ability Ignore Armor. Ranks 1 and 2 must still be paid normally.",
      special: 'Ignore Armor',
    },
    {
      level: 7,
    ...
    },
    {
      ...
      duration: 'Instant',
      effect:
        "Lor-Keth's Staff pre-fills Rank 4 of the Might Ability Ignore Armor. Ranks 1, 2, and 3 must still be paid normally.",
      special: 'Ignore Armor',
    },
    {
      level: 10,
