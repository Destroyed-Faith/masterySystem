...
export function parseD8Count(formula: string | number | null | undefined): number {
...
export function formatD8Count(count: number): string {
...
export function addD8Formulas(a: string, extraDice: number): string {
