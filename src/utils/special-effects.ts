...
export const DIMINISHING_EFFECTS: SpecialEffect[] = [
  {
    ...
    description:
      'While affected by Blight, all healing you receive is reduced by X. At Tick, take X Stress. At the start of your turn, after the Tick, Blight decays by 1.',
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'Your Attack Dice are reduced by X, to a minimum of your Mastery Rank. All dice pools used to notice, locate, track, or identify something are also reduced by X, to a minimum of your Mastery Rank. At the start of your turn, Disoriented decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'When you are hit by a Spell, take +1d8 bonus damage for every 2 Hex, rounded up. At the start of your turn, Hex decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
    removal: 'Meditation Remove Action, or Cleanse.',
    hasValue: true,
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'When a creature hits a target affected by Mark, it may spend any amount of Mark from that target before final damage is applied. The amount spent becomes the Damage Floor for that damage roll: each damage die that rolled lower than the spent value is treated as if it had rolled that value. After the roll is adjusted, reduce Mark by the amount spent. At the start of your turn, Mark decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'At Tick, heal X HP. Regeneration cannot restore lost Health Levels unless a rule says otherwise. At the start of your turn, after the Tick, Regeneration decays by 1. Regeneration is a positive effect and cannot be removed by Cleanse.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
    removal: '—',
    hasValue: true,
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'At Tick, take X damage. Ruin damage ignores Armor unless a rule says otherwise. At the start of your turn, after the Tick, Ruin decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
    removal: 'Medicine Remove Action, or Cleanse.',
    hasValue: true,
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'Your Speed is reduced by X m. If you do not voluntarily move at least 1 m during your turn, take X damage at the end of your turn. At the start of your turn, Slow decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
    removal: 'Athletics Remove Action, or Cleanse.',
    hasValue: true,
  ...
  },
  {
    ...
    category: 'diminishing',
    description:
      'When you are hit by a non-Spell attack, take +1d8 bonus damage for every 2 Sundered, rounded up. At the start of your turn, Sundered decays by 1.',
    duration: 'Diminishing (X→0)',
    stacking: 'Yes',
    removal: 'Athletics Remove Action, or Cleanse.',
    hasValue: true,
...
export const UNTIL_USED_EFFECTS: SpecialEffect[] = [
  ...
  },
  {
    ...
    category: 'untilUsed',
    description:
      'While Rooted, your Speed becomes 0 m and you cannot move voluntarily. At the start of your Turn, reduce Root by your Mastery Rank. You may also spend an Action, Movement Action, or Reaction on a Vitality Attribute Check against TN (8 × source Mastery Rank) − 2; success reduces Root by 1, plus 1 per Raise.',
 ...
 */
export const LEGACY_SPECIAL_ID_ALIASES: Readonly<Record<string, string>> = {
  bleeding: 'lacerate',
  ignite: 'ruin',
  freeze: 'slow',
  poisoned: 'blight',
