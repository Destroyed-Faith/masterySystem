 ...
 */
export function movementPowerRequiresRoll(power) {
 ...
 */
export async function useMovementPower(actor, power) {
 ...
 */
export function getMovementPowers(actor) {
    return actor.items.filter((item) => item.type === 'movement' &&
 ...
 */
export function calculateMovementPowerCost(power) {
    const system = power.system;
