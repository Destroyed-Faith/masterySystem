 ...
 */
export function getCharges(actor) {
 ...
 */
export async function spendCharge(actor, powerName = 'a Charged Power') {
 ...
 */
export async function restoreCharges(actor) {
    const masteryRank = actor.system.mastery?.rank || 2;
    await actor.update({
        'system.mastery.charges': {
            current: masteryRank,
 ...
 */
export async function burnStoneForCharges(actor) {
 ...
 */
export function canUseChargedPowerThisRound(actor) {
 ...
 */
export async function activateChargedPower(actor, power) {
 ...
 */
export function isChargedPower(power) {
 ...
 */
export function getTotalCharges(actor) {
    const charges = getCharges(actor);
