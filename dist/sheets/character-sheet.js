...
export class MasteryCharacterSheet extends BaseActorSheet {
    ...
    #onTokenSwap(e) {
        ...
        const portraitStyles = portraitContainer.length > 0 ? {
            display: window.getComputedStyle(portraitContainer[0]).display,
            visibility: window.getComputedStyle(portraitContainer[0]).visibility,
            opacity: window.getComputedStyle(portraitContainer[0]).opacity,
        ...
        const tokenStyles = tokenContainer.length > 0 ? {
            display: window.getComputedStyle(tokenContainer[0]).display,
            visibility: window.getComputedStyle(tokenContainer[0]).visibility,
            opacity: window.getComputedStyle(tokenContainer[0]).opacity,
        ...
        setTimeout(() => {
            ...
            if (portraitContainer.length > 0 && tokenContainer.length > 0) {
                const portraitElAfter = portraitContainer[0];
                const tokenElAfter = tokenContainer[0];
