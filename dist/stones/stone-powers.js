...
const GENERIC_POWERS = [
    ...
    },
    {
        ...
        apply: async (actor, _combatant) => {
            ...
            await actor.setFlag('mastery-system', 'rerollAvailable', true);
            await actor.setFlag('mastery-system', 'rerollType', 'any');
        }
    },
    {
...
const MIGHT_POWERS = [
    ...
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            ...
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['bleeding', 'entangle', 'grappled']);
        }
    }
];
/**
...
const AGILITY_POWERS = [
    ...
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['ignite', 'freeze', 'shock']);
        }
    }
];
/**
...
const VITALITY_POWERS = [
    ...
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['stunned', 'disoriented', 'prone']);
        }
    }
];
/**
...
const INTELLECT_POWERS = [
    ...
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['torment', 'mark', 'bleed']);
        }
    }
];
/**
...
const RESOLVE_POWERS = [
    {
        ...
        apply: async (actor, _combatant) => {
            await actor.setFlag('mastery-system', 'rerollAvailable', true);
            await actor.setFlag('mastery-system', 'rerollType', 'mindSpirit');
        }
    },
    {
    ...
    },
    {
        ...
        apply: async (actor, _combatant) => {
            await actor.setFlag('mastery-system', 'stressImmunity', true);
        }
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['soulburn', 'curse', 'hex']);
        }
    }
];
/**
...
const INFLUENCE_POWERS = [
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingAllyPoolBonus', { poolDice: 1, keepDice: 0 });
        }
    },
    {
        id: 'influence.fear',
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingFear', { range: 5 });
        }
    },
    {
    ...
    },
    {
        ...
        apply: async (_actor, _combatant) => {
            await _actor.setFlag('mastery-system', 'pendingRemoveSpecials', ['frightened', 'charmed', 'disorient']);
        }
    }
];
/**
