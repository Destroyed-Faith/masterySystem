...
import { markZoneApplied, readSpellZones, zoneAlreadyApplied, zoneApplicationOutcome, } from './spell-zones.js';
function actorList() {
...
export async function applyStoredSpellZonesOnEnter(creature, tokenDoc, combat) {
    ...
    for (const caster of actorList()) {
        ...
        for (const zone of zones) {
            ...
            const dist = metersBetween(scene, zone.centerX, zone.centerY, x, y);
