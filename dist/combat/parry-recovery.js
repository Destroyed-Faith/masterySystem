 ...
 */
export function computeParryRecovery(input) {
...
export function readParryRecoveryCap(actor) {
    let best = 0;
    for (const effect of effectList(actor)) {
        ...
        const isRecovery = tid === 'ab-reinforced-parry' ||
...
//# sourceMappingURL=parry-recovery.js.map