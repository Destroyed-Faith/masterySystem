 ...
 */
export declare const ENCOUNTER_TUNING: {
    /**
     ...
     */
    readonly phaseCollapseWarnRounds: 1.35;
    /**
     ...
     */
    readonly favorableOutputFactor: 1.3;
    readonly unfavorableOutputFactor: 0.75;
    /**
     ...
     */
    readonly minRoundsUnderBurst: 1.5;
    /**
     ...
     * unreasonable burst.
     */
    readonly singleHitHealthFractionWarn: 0.45;
    /**
     ...
     */
    readonly addActionWeight: 0.5;
    /** Minimum offensive actions for any active main enemy body. */
    readonly minActionsPerBody: 1;
    /**
     ...
     */
    readonly excessiveActionRatio: 1.5;
    /**
     ...
     */
    readonly targetNpcHitChance: 0.6;
    /** Solver search space for NPC attack pools (exploding d8 count). */
    readonly minAttackPool: 2;
    readonly maxAttackPool: 20;
    /** Solver search space for NPC damage dice per attack. */
    readonly minDamageDice: 1;
    readonly maxDamageDice: 16;
    /** Solver search space for solved NPC special magnitudes. */
    readonly minSpecialValue: 1;
    readonly maxSpecialValue: 6;
    /**
     ...
     * feel irrelevant.
     */
    readonly targetPartyHitChanceVsNpc: 0.65;
    /**
     ...
     */
    readonly defenseShareTargets: Record<string, number[]>;
    /**
     ...
     */
    readonly defenseUselessShareWarn: 0.06;
    /**
     ...
     */
    readonly aoeOccupancyCases: {
        readonly single: 1;
        readonly typicalFraction: 0.5;
        readonly dangerousFraction: 0.85;
    };
    /**
     ...
     */
    readonly specialAccumulationWarnFraction: 0.75;
    /**
     ...
     */
    readonly focusFireEfficiency: 0.9;
    /**
     ...
     */
    readonly meleeUptimeVsEscaping: 0.75;
    /**
     ...
     * matches this share.
     */
    readonly specialShareOfAttackBudget: 0.3;
    /**
     ...
     */
    readonly totalMitigationTarget: 0.45;
    /**
     ...
     */
    readonly baselineHitChanceVsNpc: 0.85;
    /**
     ...
     */
    readonly reactionUsageRate: 0.75;
    /**
