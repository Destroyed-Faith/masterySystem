...
export function splitNpcInitiativeModifier(raw) {
...
export function formatNpcInitiativeSigned(net) {
...
export function getNpcInitiativeModifier(actor) {
    if (!actor?.system)
        return 0;
...
//# sourceMappingURL=npc-initiative.js.map