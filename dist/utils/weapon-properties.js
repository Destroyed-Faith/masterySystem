...
export function weaponInnates(item) {
...
export function hasWeaponProperty(item, property) {
...
export function isWieldedTwoHanded(item) {
    if (!item)
        return false;
...
export function versatileBonusDice(weapon) {
    if (!weapon || !hasWeaponProperty(weapon, 'versatile'))
        return 0;
 ...
 */
export function setBonusDice(actor, weapon) {
    if (!weapon || !hasWeaponProperty(weapon, 'set'))
        return 0;
...
export function defensiveEvadeBonus(actor, weapon) {
    if (!weapon || !hasWeaponProperty(weapon, 'defensive'))
        return 0;
    if (!isWieldedTwoHanded(weapon))
        return 0;
