...
export function getWorldDefaultMasteryRank() {
    try {
        const raw = game?.settings?.get('mastery-system', 'defaultMasteryRank');
 ...
 */
export function getRulesMasteryRank(actorOrSystem) {
 ...
 */
export function lifetimeXpFloorFromPermanentStones(totalStones) {
