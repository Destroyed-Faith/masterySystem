...
export function canSpendArtifactLinkStone(_actor) {
    return true;
}
/** Activation is free (Artefacts.md) — always true, kept for callers. */
export function canSpendArtifactLinkStoneFromPool(_actor, _stoneAttr) {
    return true;
}
...
export async function spendArtifactLinkStone(_actor, _stoneAttr) {
    return true;
}
/** No activation Stone exists any more — nothing to refund. */
export async function refundArtifactLinkStone(_actor, _stoneAttr) {
    return true;
}
