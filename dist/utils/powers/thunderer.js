 ...
 */
export const THUNDERER_POWERS = [
    {
        name: 'Storm Needle',
        category: 'active',
        tags: ['spell'],
        rank: 1,
        fluff: 'A thin lance of lightning snaps from your hand and leaves the target\'s body trembling with stolen momentum.',
        cost: {
            action: 'attack',
            stones: 0
        },
    ...
    },
    {
        ...
        tags: ['spell', 'charged'],
        rank: 1,
        fluff: 'Lightning forks outward in branching lines, hunting several bodies before the first scream is done.',
        cost: {
            action: 'attack',
            stones: 0,
            charges: 1
    ...
    },
    {
        ...
        tags: ['spell'],
        rank: 1,
        fluff: 'You stamp a rune of pressure into the air, and the next heartbeat becomes a burst of sound and white-blue force.',
        cost: {
            action: 'attack',
            stones: 0
        },
    ...
    },
    {
        ...
        tags: ['spell'],
        rank: 1,
        fluff: 'At the center of your storm, motion bends, voices blur, and every ally moves half a beat ahead of the world.',
        cost: {
            action: 'none',
            stones: 0
        },
    ...
    },
    {
        ...
        tags: ['spell'],
        rank: 1,
        fluff: 'Your storm wraps companions in a trembling veil; enemies already rattled by Shock find no clean angle.',
        cost: {
            action: 'none',
            stones: 0
        },
...
//# sourceMappingURL=thunderer.js.map