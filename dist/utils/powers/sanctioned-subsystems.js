 ...
 */
export const DAMAGE_REDUCTION_PASSIVE = {
...
export const UNYIELDING_SHELL_BUFF = {
...
export const UNYIELDING_INTERCEPT_REACTION = {
...
export const GHOSTFORM_PASSIVE = {
    name: 'Ghostform',
    category: 'passive',
    tags: [],
    rank: 1,
...
export const GHOST_MANTLE_BUFF = {
    name: 'Ghost Mantle',
    category: 'activeBuff',
    tags: [],
    rank: 1,
...
export const GHOST_SLIP_REACTION = {
    name: 'Ghost Slip',
    category: 'reaction',
    tags: [],
    rank: 1,
...
export const SANCTIONED_SUBSYSTEM_POWERS = [
...
export const SANCTIONED_PHASING_NAMES = ['Ghostform', 'Ghost Mantle', 'Ghost Slip'];
//# sourceMappingURL=sanctioned-subsystems.js.map