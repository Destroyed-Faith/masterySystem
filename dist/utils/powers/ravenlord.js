    ...
    },
    {
        ...
        levels: {
            '1': {
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 1 },
                effect: { text: 'One ally gains +2 Initiative and +1 Attack Die' },
                specials: []
            },
            '2': {
                type: 'utility',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 1 },
                effect: { text: 'One ally gains +2 Initiative and +3 Attack Dice' },
                specials: []
            },
            '3': {
                type: 'utility',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 1 },
                effect: { text: 'One ally gains +4 Initiative, +4 Attack Dice, and Crit(1)' },
                specials: []
            },
            '4': {
                type: 'utility',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 1 },
                effect: { text: 'One ally gains +4 Initiative, Advantage, and Crit(2)' },
                specials: []
            }
        }
    },
    {
        ...
        levels: {
            '1': {
                ...
                effect: { text: 'Gain +2 Initiative and +2 Perception. You may summon a Raven Familiar (1 HP, Speed 10m, Fly, Perception +4). It can scout but cannot attack' },
                specials: []
            },
            '2': {
                type: 'passive',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +4 Initiative and +4 Perception. The Familiar may use Help once per round (grant Advantage to an ally\'s Perception or Attack vs. a Marked enemy within 4m)' },
                specials: []
            },
            '3': {
                type: 'passive',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +6 Initiative and +6 Perception. The Familiar may apply Mark(1) once per encounter as a free action to an enemy within 8m' },
                specials: []
            },
            '4': {
                type: 'passive',
                ...
                aoe: { shape: 'none' },
                duration: { kind: 'rounds', rounds: 999, note: 'permanent' },
                effect: { text: 'Gain +8 Initiative and +8 Perception; you cannot be Surprised. The Familiar may use Help twice per round, and you may see/hear through it for 1 round per Mastery Rank' },
                specials: []
            }
        }
    },
