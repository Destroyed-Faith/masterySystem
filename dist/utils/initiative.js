 ...
 */
import { INITIATIVE_SHOP, EXPLODE_VALUE } from './constants.js';
/**
 ...
 */
export async function rollInitiativeDice(actor, withStones = false, stoneActivations = 0) {
    const system = actor.system;
 ...
 */
export function calculateShopCost(purchases) {
    let cost = 0;
 ...
 */
export function validateShopPurchases(rawInitiative, purchases) {
 ...
 */
export async function applyShopPurchases(actor, purchases) {
    const updates = {};
    // Add extra movement
 ...
 */
export async function createInitiativeChatMessage(actor, baseInitiative, masteryRoll, rawInitiative, shopResult) {
 ...
 */
export async function rollNpcInitiative(actor, combatant) {
