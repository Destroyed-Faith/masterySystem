...
export const MINOR_EXPRESSIONS = [
    {
        ...
        attribute: M,
        name: 'Hold the Door',
        tagline: 'Du kannst für einen Moment etwas aufhalten, das eigentlich nicht aufzuhalten sein sollte.',
        tiers: {
    ...
    },
    {
        ...
        attribute: M,
        name: 'Titan Carry',
        tagline: 'Du trägst Menschen, Lasten oder sperrige Dinge so, als wären sie für dich weniger relevant als für andere.',
        tiers: {
    ...
    },
    {
        ...
        attribute: A,
        name: 'Bounding Leap',
        tagline: 'Du kannst deutlich weiter und höher springen, als normale Bewegung erwarten ließe.',
        tiers: {
    ...
    },
    {
        ...
        attribute: A,
        name: 'Catfall',
        tagline: 'Du kannst große Stürze oder Sprünge extrem weich, rollend oder federnd abfangen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: A,
        name: 'Wall Spring',
        tagline: 'Du kannst Wände, Vorsprünge oder schräge Flächen für einen zusätzlichen Satz oder Richtungswechsel nutzen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: A,
        name: 'Flow Through',
        tagline: 'Du kannst dich durch enge, chaotische oder vertikale Umgebungen fast fließend bewegen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: I,
        name: 'Mage Hand',
        tagline: 'Du erschaffst eine kleine magische Kraft/Hand, die leichte Gegenstände auf kurze Distanz bewegen, holen oder kippen kann.',
        tiers: {
    ...
    },
    {
        ...
        attribute: I,
        name: 'Message',
        tagline: 'Du kannst einer Person in kurzer Distanz eine leise, gezielte Botschaft zuflüstern, die nur sie hört.',
        tiers: {
    ...
    },
    {
        ...
        attribute: I,
        name: 'Arcane Spark',
        tagline: 'Du erzeugst kleine Lichtpunkte, Funken, Glyphenflackern oder sichtbare arkane Markierungen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: I,
        name: 'Detect Trace',
        tagline: 'Du kannst schwache magische Rückstände, Resonanzen oder Ritualspuren wahrnehmen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: I,
        name: 'Script Whisper',
        tagline: 'Du erschaffst geheime, unsichtbare Runen oder Zeichen, die nur unter den richtigen Umständen lesbar werden.',
        tiers: {
    ...
    },
    {
        ...
        tagline: 'Du erschaffst eine kleine Menge einfacher Materie oder Substanz für kurze Zeit.',
        constraints: 'Wichtige Grenze: nur einfache Materie; nichts Präzisionsgebautes; nichts Komplexlebendiges; nichts, was echte Herstellung, Rituale oder Powers ersetzen soll.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Alarm',
        tagline: 'Du setzt auf einen Gegenstand, Schlafplatz, Zugang oder kleinen Bereich eine stille Warnung, die dich aufmerksam macht, wenn sie gebrochen wird.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Still Mind',
        tagline: 'Du kannst deinen Geist in kurzer Zeit sammeln, ordnen und gegen Panik, Verwirrung oder aufsteigende Unruhe abschirmen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Read Omen',
        tagline: 'Du kannst aus Stimmung, Zeichen, Zufällen, Tierverhalten, Wind, Stille oder kleinen Unstimmigkeiten ein gutes oder ungutes Vorzeichen lesen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Cold Comfort',
        tagline: 'Du kannst jemandem mit ruhiger Gewissheit, dunkler Ehrlichkeit oder stiller Zuversicht Halt geben, ohne falsche Hoffnung zu machen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Sense Taint',
        tagline: 'Du kannst an Orten, Dingen oder Personen spüren, ob etwas verdorben, falsch, unheilvoll oder geistig „schmutzig“ ist.',
        tiers: {
    ...
    },
    {
        ...
        attribute: R,
        name: 'Keep Watch',
        tagline: 'Du kannst in stiller Konzentration über lange Zeit wach, aufmerksam und innerlich gespannt bleiben, fast als würdest du auf etwas Unsichtbares lauschen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: F,
        name: 'Mirror Shade',
        tagline: 'Du erzeugst einen kurzen Verwechslungs- oder Doppelbild-Effekt um dich herum.',
        tiers: {
    ...
    },
    {
        ...
        attribute: F,
        name: 'Silver Tongue',
        tagline: 'Deine Worte können andere für einen kurzen Moment ihre eigenen Interessen, Vorbehalte, Verletzungen oder Vorsicht vergessen lassen.',
        tiers: {
    ...
    },
    {
        ...
        tagline: 'Du spürst schnell, wenn eine Situation kippt, etwas faul ist oder Ärger in der Luft liegt.',
        tiers: {
    ...
    },
    {
        ...
        attribute: W,
        name: 'Quick Read',
        tagline: 'Du kannst eine Person, ein Objekt oder eine Situation in wenigen Augenblicken grob, aber oft treffsicher einschätzen.',
        tiers: {
    ...
    },
    {
        ...
        attribute: W,
        name: 'Find the Angle',
        tagline: 'Du erkennst rasch den einfachsten, cleversten oder praktischsten Ansatzpunkt in einer Situation.',
        tiers: {
    ...
    },
    {
        ...
        tagline: 'Du verlierst in chaotischen Gesprächen, Szenen oder Suchmomenten nicht so leicht den Faden.',
        tiers: {
    ...
    },
    {
        ...
        attribute: W,
        name: 'Street Sense',
        tagline: 'Du findest dich in Gassen, Märkten, Lagern, Tavernen und unübersichtlichen Alltagsräumen schnell zurecht.',
        tiers: {
...
export function isTierUnlocked(attributeValue, tier) {
