...
export function ritualCategoryLabels(ritual) {
...
export function ritualStoneCost(ritual, declaredRaises) {
...
export function ritualMaxRaise(ritual) {
...
export function resolveRitualDeclaredOutcome(opts) {
    ...
    if (outcome === 'fail')
        return { success: false, appliedRaise: 0, kind: 'fail' };
    if (outcome === 'partial')
        return { success: true, appliedRaise: 0, kind: 'raise0' };
    return { success: true, appliedRaise: declared, kind: 'full' };
}
export function appliedRitualEffects(ritual, appliedRaise) {
...
export const RITUALS = [
    {
        ...
        name: 'Read Resonance',
        description: 'You quiet your senses and listen for the pressure left behind when power touched the world.',
        stoneCost: 1,
    ...
    },
    {
        ...
        name: 'Locate Object',
        description: 'You close your eyes and trace a pattern in the air. A pull forms within your mind, guiding you toward what you seek.',
        stoneCost: 1,
    ...
    },
    {
        ...
        limits: 'Requires a known place or a familiar creature. Does not reveal hidden truths automatically. Does not bypass story-level wards, divine concealment, demonic deception, Artifact will, or specific GM protection. Does not allow you to act through the vision.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Not a defensive ward. Does not create Armor, Evade, Temporary HP, concealment, a Safe Haven, or a barrier. Does not stop anyone from entering. It only warns.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Does not replace Engineering, lockpicking, digging, or breaking objects by mundane means. It creates or breaks a supernatural seal on an existing passage. Opening mode cannot create a passage where none exists.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Does not create a Safe Haven. Does not hide evidence, remove mundane blood, erase tracks, restore destroyed structures, or undo ordinary consequences. Does not replace First Aid. Does not restore HP, lost Health Levels, or Scarred Health Bars.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Does not use the word Echo because Echo refers to playable ancestry. Reads emotional residue, not objective recordings. A memory may be incomplete, symbolic, distorted, or protected. Cannot prove every factual detail of an event. Cannot replace Investigation when ordinary evidence is available.',
        raises: [
    ...
    },
    {
        ...
        name: 'Word of Recall',
        description: 'You etch a hidden mark of return upon a sanctuary, a promise to the world that you will one day come home.',
        stoneCost: 1,
        ...
        specialCostNote: 'The Stones paid for Word of Recall remain Sealed while the mark exists. They return only after the mark is used, dismissed, broken, or removed, followed by a Safe Haven Rest. Activating the mark is not a combat action. Unless a specific rule says otherwise, activating the recall requires at least 1 Forearm of focus outside combat.',
        limits: 'Cannot target a place you have never reached. Cannot create safety at the destination. Cannot be used as a combat escape unless a specific rule explicitly allows it. Cannot bypass story-level seals, divine locks, demonic anchors, or explicit travel bans unless the GM allows it.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Cannot rewrite a mind. Cannot cure trauma by itself. Cannot force a protected target to reveal secrets without appropriate MR, Raise Level, and GM approval. Cannot control the dreamer. Cannot replace Social Skills, therapy, confession, or player choice.',
        raises: [
    ...
    },
    {
        ...
        limits: 'Not resurrection. Cannot call the dead back to life. Does not destroy active undead enemies by itself. Does not create a Safe Haven. Helps the dead pass on and helps prevent ordinary undeath or spiritual corruption from taking hold.',
        raises: [
