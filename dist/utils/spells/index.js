 ...
 */
export function getSpellsForSchool(schoolName) {
 ...
 */
export function getSpell(schoolName, spellName) {
    return ALL_SPELLS.find(spell => spell.school === schoolName && spell.name === spellName);
}
/**
 * Get all available school names that have spells defined
 */
export function getSchoolsWithSpells() {
