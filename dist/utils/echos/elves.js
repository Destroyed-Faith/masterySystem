    ...
    subChoices: [
        {
            ...
            trait: {
                ...
                effect: 'Mastery Rank per Safe Haven Rest: when you are hit by an attack, after the roll but before damage is applied, conjure a plate of earth and glyph-stone. Gain Armor + your Mastery Rank against that one attack only.',
        ...
        },
        {
            ...
            trait: {
                id: 'wind-first',
                name: 'Wind-First',
                effect: 'Mastery Rank per Safe Haven Rest: when you roll Initiative, after seeing your result, add your doubled Mastery Rank to your Initiative total.',
        ...
        },
        {
            ...
            trait: {
                id: 'tidal-slip',
                name: 'Tidal Slip',
                effect: 'Mastery Rank per Safe Haven Rest: when an enemy targets you with an attack and the roll is already made, raise your Evade by + your Mastery Rank against that one attack.',
        ...
        },
        {
            ...
            trait: {
                id: 'ember-surge',
                name: 'Ember Surge',
                effect: 'Mastery Rank per Safe Haven Rest: when you hit with an attack, before rolling damage, add a number of bonus damage dice equal to your Mastery Rank to that damage pool.',
