export const TITANBORN_ECHO = {
    ...
    summary: 'Awakened fury of the godless age. Where others break, Titanborn endure. Where others retreat, they advance. Their greatest struggle is often against the ancient hunger within them, the part that does not want the war to end.',
    ...
    coreTraits: [
        {
            id: 'large-form',
            name: 'Large Form',
            effect: 'Starting at Mastery Level 3, you can use an Action to become Large, if space allows. No duration limit; may end at will.',
        ...
        },
        {
            id: 'true-form',
            name: 'True Form',
            effect: 'Starting at Mastery Level 6, once per Safe Haven Rest, as an Action, enter your True Titan Form for 1 minute. Become Huge and Armor +6.',
...
//# sourceMappingURL=titanborn.js.map