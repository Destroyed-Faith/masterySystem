...
const LANTERN_OF_THE_HOLLOW_STAR = {
    ...
    slot: 'amulet',
    baseProfile: 'lantern',
    description: 'A bound Amulet Artifact shaped like a black lantern filled with pale inner fire. It is not a shield. It grants no Armor, no Evade, no Weapon Damage, and no Base Value \u2014 all of its power is written into its three Stone Functions. It is one of the eight Artifacts in the world that may carry three Stone Functions at once.',
    ...
    levelProgression: [
        {
            ...
            range: 'Self',
            duration: 'Special',
            effect: 'The Lantern fully awakens. Choose or define one final Stone Battery, Resolve Pool, Recovery, or stored-stone effect with GM approval.',
