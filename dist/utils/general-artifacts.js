...
const SOUL_SIGIL = {
    ...
    restriction: 'The Soul Sigil occupies the Body Slot. Silver Veil uses the Evade Body Armor profile (Light Armor layer + Evade). The Soul Sigil cannot be worn together with another Body Artifact. Listed Armor values are the full Silver Veil totals — no extra Artifact Armor Bonus.',
    stoneFunction: {
