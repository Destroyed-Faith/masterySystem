 ...
 */
export declare const SCENE_EDITOR_FLAG = "sceneEditor";
export declare const SCENE_EDITOR_WALL_FLAG = "sceneEditorWall";
export declare const SCENE_EDITOR_SCHEMA_VERSION = 1;
export declare const SCENE_EDITOR_VERSION = "1.0.0";
export type EditorTool = 'select' | 'wall' | 'door' | 'window' | 'hint' | 'ignore' | 'region-analyze';
...
export type EditorStatus = 'saved' | 'saving' | 'dirty' | 'analyzing' | 'analyzed' | 'stale' | 'background-changed' | 'no-map';
...
export declare const DEFAULT_LAYER_VISIBILITY: AnalysisLayerVisibility;
...
export declare function emptyStored(sceneId: string): SceneEditorStored;
