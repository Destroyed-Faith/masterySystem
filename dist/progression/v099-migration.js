...
export function planV099Migration(actor) {
...
export function v099PrepareUpdate(actor) {
...
export async function runV099CoreMigration(actors) {
...
export function registerV099SchemaSetting() {
    try {
        globalThis.game?.settings?.register?.('mastery-system', 'schemaVersion', {
...
//# sourceMappingURL=v099-migration.js.map