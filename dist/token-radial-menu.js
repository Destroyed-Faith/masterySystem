 ...
 */
function highlightRangeHexes(center, rangeUnits, highlightId) {
    if (!canvas.grid)
        return;
    // Get highlight layer
    let highlight = null;
            ...
            if (distanceInUnits <= rangeUnits) {
                ...
                try {
                    ...
                    // Direct grid highlight (v13)
                        ...
                        canvas.grid.highlightPosition(gridCol, gridRow, { color: 0x00ffff, alpha: 0.4 });
                    }
 ...
 */
function renderOuterRing(root, token, bySegment, segmentId) {
 ...
 */
function renderInnerSegments(root, getCurrentSegmentId, setCurrentSegmentId) {
 ...
 */
function refreshInnerSegmentsVisual(root, getCurrentSegmentId) {
