...
|---|---|---|
| **Foundry VTT system** (`mastery-system`) | `package.json` + `system.json` | Continues as `0.9.257`, `0.9.258`, … |
...
- Current Foundry system version: whatever is in `package.json` / `system.json` (today **0.9.257**).
